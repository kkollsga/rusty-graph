...
regulations = pd.DataFrame(
    {
        ...
        "effective_from": ["2018-05-25", "2019-01-01", "2016-03-01", "2021-01-01", "2020-06-15", "2013-07-01"],
...
graph.add_connections(cites, "CITES", "CourtDecision", "decision_id", "Law", "law_id", columns=["weight"])
