//! Python-facing `#[pymethods] impl KnowledgeGraph` block.
//!
//! Moved out of `graph::mod.rs` in Phase 8. Further splits into
//! `kg_core`, `kg_mutation`, `kg_introspection`, `kg_fluent` are
//! scheduled for Phase 9 alongside other god-file content splits.
...
use crate::graph::schema::{
    self, ConnectionSchemaDefinition, CowSelection, DirGraph, NodeSchemaDefinition, PlanStep,
    SchemaDefinition,
};
use crate::graph::storage::GraphRead;
use crate::graph::{
    compare_inner, extract_cypher_param, extract_detail_param, extract_fluent_param, get_graph_mut,
    parse_inline_timeseries, parse_method_param, parse_spatial_column_types,
